...
def lit_regime_g1(signals, pxm):
    """★telecom = 금리 regime (G1 ex-ante). asset_stable 금리민감 (배당주 = 금리 상승 시 디레이팅).
    rate_up = 배당주 약세 가설 → regime별 IC 부호 점검. ★단 service sub n=3 = cross-sectional 한계."""
    try:
        ...
        out = {"regime_counts": regime.value_counts().to_dict(),
               "note": "금리(US 10Y) 3M Δ regime ex-ante. asset_stable 배당주 = rate_up 디레이팅 가설. KR 금리 proxy.",
