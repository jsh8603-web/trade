...
- **R15 데이터/PIT 분담 완료(2026-05-29)**: 신규 4모듈(weight_panel/weight_card_store/cv_split/cold_start_ood) + 2확장(data_contract/lineage). 전수 회귀 PASS/0 FAIL. btn-Codlearn 통합 대기(WeightAssumptionCard 정의↔내 store 배선, b(t) frozen↔model_hash pin).
